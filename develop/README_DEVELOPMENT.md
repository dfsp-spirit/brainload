...
This document is intended for developers who work on `brainload`. Users should ignore this file and install a release via `pip` instead. See the `README` file in the repo root for details.
...
Note: From here on, I will assume that you cloned
