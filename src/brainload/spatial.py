...
def get_freesurfer_matrix_vox2ras():
    ...
    Generated by running: `mri_info --vox2ras-tkr $FREESURFER_HOME/subjects/fsaverage/mri/orig.mgz`

    See also http://eeg.sourceforge.net/doc_m2html/bioelectromagnetism/freesurfer_surf2voxels.html. Quoting from that page:
    'FreeSurfer MRI volumes are 256^3 voxels, 1mm^3 each. The MRI volume index has an origin at the left, posterior, inferior voxel, such that:
